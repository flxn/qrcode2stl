export default {
  ...
  batchModeDescription: 'Generate multiple QR codes from a CSV file. Each row in the CSV will create a separate STL file.',
  batchHowToTitle: 'How to use Batch Mode:',
