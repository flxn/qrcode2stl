export default {
  ...
  magnetPockets: 'Magnet pockets',
  magnetPocketsHelp: 'Adds 4 round glue pockets on the underside of the base, one near each corner.',
  holeSize: 'Hole size',
  offsetFromOuterEdge: 'Offset from outer edge',
